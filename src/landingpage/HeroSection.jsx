...
const slides = [
    { src: '/images/kv-skyexchange-m.webp',   alt: 'Welcome to Skyexchange – India\'s Trusted Betting Platform' },
    { src: '/images/kv-skyexchange-2-m.webp', alt: 'Skyexchange – Your Ultimate Gaming Destination' },
];
